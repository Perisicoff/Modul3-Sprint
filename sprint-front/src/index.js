...
import NoviZadatak from './components/zadaci/NoviZadatak';
import IzmenaZadatka from './components/zadaci/IzmenaZadatka';
              ...
              <Router>
                ...
                Sprint
                  ...
                  <Nav className="navbar-links-center">
                    <Nav.Link className="text-white bg-dark" as={Link} to="/zadaci">
                      Zadaci
                    </Nav.Link>
